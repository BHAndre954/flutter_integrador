...
import 'package:p_integrador/pregunta_letra4/splash_screen12.dart';

class Pregunta3_2 extends StatefulWidget {
  @override
  _Pregunta3_2 createState() => _Pregunta3_2();
}

class _Pregunta3_2 extends State<Pregunta3_2> {
  @override
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Image.asset(
              'assets/Sa5.png', // Reemplaza con la ruta de tu imagen
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => SplashScreen12(),
                  ),
                );
              },
