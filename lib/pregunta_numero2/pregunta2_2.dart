...
import 'package:p_integrador/pregunta_numero3/splash_screen24.dart';

class Pregunta2_2 extends StatefulWidget {
  @override
  _Pregunta2_2 createState() => _Pregunta2_2();
}

class _Pregunta2_2 extends State<Pregunta2_2> {
  @override
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Image.asset(
              'assets/Num8.png', // Reemplaza con la ruta de tu imagen
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => SplashScreen24(),
                  ),
                );
              },
